...
opcao = st.sidebar.selectbox("Opções", ["1. Adicionar Conta", "2. Mostrar Sumário", "3. Notificações", "4. Dar Baixa", "5. Editar Conta", "6. Limpar Contas", "7. Sair"])
...
if "1." in opcao:
    ...
    st.info("Obrigado por usar o sistema! Feche a aba para sair.")
